...
@section('header_styles')
    ...
    <link href="{{ asset('assets/css/custom_css/custom_summernote.css') }}" rel="stylesheet" type="text/css"/>
...
@section('content')
    ...
    <script src="{{ asset('assets/js/custom_js/wysihtml5.js') }}" type="text/javascript"></script>
@stop