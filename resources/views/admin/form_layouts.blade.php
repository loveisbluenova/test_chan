...
<link href="{{ asset('assets/css/custom_css/custom_form_layout.css') }}" rel="stylesheet" type="text/css"/>
@stop
{{-- Page content --}}
@section('content')
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <form action="#" class="form-horizontal">
                                            <div class="form-position" id="mrg_left9">
                                        ...
                                        <form action="#" class="form-horizontal">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="inputContent" class="col-md-3 control-label">Message</label>
                                                    <div class="col-md-6">
                                                        <textarea id="inputContent" rows="3" class="form-control" style="resize: none;"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-actions" id="mrg_left9">
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/js/custom_js/custom_form_layout.js') }}"></script>
@stop