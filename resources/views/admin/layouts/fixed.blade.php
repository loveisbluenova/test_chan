...
<head>
    ...
    <link href="{{ asset('assets/css/custom_css/fixed_layout.css') }}" rel="stylesheet" type="text/css" />
    <!-- end of global css -->
    <!--page level css-->
    @yield('header_styles')
...
<body class="skin-chandra fixed_menu">
            ...
            <section class="sidebar ">
                <div id="menu" role="navigation">
                    ...
                    <ul class="navigation">
                        ...
                        <!--{{--<li class="menu-dropdown {{ (Request::is('admin/generator_builder')  ? 'active' : '') }}">--}}-->
                        <!--{{--<a href="#">--}}-->
                        <!--{{--<i class="menu-icon  fa fa-fw fa-paw"></i>--}}-->
                        <!--{{--<span>GUI Crud Builder</span>--}}-->
                        <!--{{--<span class="fa arrow"></span>--}}-->
                        <!--{{--</a>--}}-->
                        <!--{{--<ul class="sub-menu">--}}-->
                        <!--{{--<li {{ (Request::is('admin/generator_builder') ) }}>--}}-->
                        <!--{{--<a href="{{ URL::to('admin/generator_builder') }}">--}}-->
    ...
    <script src="{{ asset('assets/vendors/jquery-slimscroll/js/jquery.slimscroll.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/custom_js/rightside_bar.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/js/custom_js/fixed_layout.js') }}" type="text/javascript"></script>
