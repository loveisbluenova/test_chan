...
@section('header_styles')
    ...
    <link href="{{ asset('assets/css/custom_css/custom_gui_builder.css') }}" rel="stylesheet" />
@stop
...
//            $('.close').click();
        ...
        $(document).on("ready",function(){
            $('#chkDataTable').on('ifChecked', function(event){
               $(".chkSearchable").iCheck('check');
            });
            $('#chkDataTable').on('ifUnchecked', function(event){
                $(".chkSearchable").iCheck('uncheck');
            });
        })
