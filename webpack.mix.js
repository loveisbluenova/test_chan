...
let vendors = 'resources/assets/vendors/';
let resourcesAssets = 'resources/assets/';
let srcCss = resourcesAssets + 'css/';
let srcJs = resourcesAssets + 'js/';

mix.copy(srcCss+'custom_css/g_maps.css','public/assets/css/custom_css/');
...
mix.copy('resources/assets/vendors/jquery-ui/themes/base/images', 'public/assets/img', false);
mix.copy('resources/assets/img', 'public/assets/img', false);
mix.copy('resources/assets/images', 'public/assets/images', false);

// Sweet Alert
mix.copy('resources/assets/vendors/sweetalert/dist/sweetalert.css', 'public/assets/vendors/sweetalert/css');
mix.copy('resources/assets/vendors/sweetalert/dist/sweetalert.min.js', 'public/assets/vendors/sweetalert/js');
mix.copy('resources/assets/vendors/sweetalert/dist/sweetalert-dev.js', 'public/assets/vendors/sweetalert/js');

//  gui builder
mix.copy('resources/assets/css/custom_css/custom_gui_builder.css', 'public/assets/css/custom_css');

//copy admin style switcher to public for index page
mix.copy('resources/assets/js/custom_js/style_switcher_index.js', 'public/assets/js/custom_js');
...
mix.copy('resources/assets/js/custom_js/custom_form_layout.js', 'public/assets/js/custom_js');
mix.copy('resources/assets/css/custom_css/custom_form_layout.css', 'public/assets/css/custom_css');

// //icheck
mix.copy('resources/assets/vendors/iCheck/icheck.js', 'public/assets/vendors/iCheck/js');
mix.copy('resources/assets/vendors/iCheck/skins', 'public/assets/vendors/iCheck/css', false);
...
// owl-carousel
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.carousel.css', 'public/assets/vendors/owl.carousel/css');
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.theme.css', 'public/assets/vendors/owl.carousel/css');
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.transitions.css', 'public/assets/vendors/owl.carousel/css');
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.carousel.min.js', 'public/assets/vendors/owl.carousel/js');
...
mix.copy('resources/assets/css/custom_css/custom_summernote.css', 'public/assets/css/custom_css/');
mix.copy('resources/assets/vendors/summernote/dist/font', 'public/assets/vendors/summernote/css/font');
...
//layout css
mix.copy('resources/assets/css/custom_css/layout_responsive.css', 'public/assets/css/custom_css');
...
//jquery input-mask
mix.copy('resources/assets/vendors/jquery.inputmask/dist/', 'public/assets/vendors/jquery_inputmask/');
...
mix.copy('resources/assets/vendors/ckeditor/skins/', 'public/assets/vendors/ckeditor/js/skins',false);
mix.copy('resources/assets/vendors/ckeditor/plugins/', 'public/assets/vendors/ckeditor/js/plugins');
...
mix.copy('resources/assets/js/custom_js/wysihtml5.js', 'public/assets/js/custom_js');
...
mix.copy('resources/assets/css/custom_css/pickers.css', 'public/assets/css/custom_css');
// flippant
...
mix.copy('resources/assets/css/custom_css/custom_panel_page.css', 'public/assets/css/custom_css');
...
mix.copy('resources/assets/vendors/bootstrap-tagsinput/dist/bootstrap-tagsinput.js', 'public/assets/vendors/bootstrap-tagsinput/js');
mix.copy('resources/assets/css/custom_css/tag_input.css', 'public/assets/css/custom_css');
...
//fancybox
mix.copy('resources/assets/vendors/fancybox/source', 'public/assets/vendors/fancybox', false);
mix.copy('resources/assets/vendors/fancybox/lib/jquery.mousewheel.pack.js', 'public/assets/vendors/fancybox');
...
mix.copy('resources/assets/vendors/blueimp-gallery-with-desc/img/', 'public/assets/vendors/blueimp-gallery-with-desc/img', false);
...
//fixed Layout
mix.copy('resources/assets/js/custom_js/fixed_layout.js', 'public/assets/js/custom_js');
mix.copy('resources/assets/css/custom_css/fixed_layout.css', 'public/assets/css/custom_css');
...
//slimscroll
mix.copy('resources/assets/vendors/jquery-slimscroll/jquery.slimscroll.min.js', 'public/assets/vendors/jquery-slimscroll/js');
...
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.theme.css', 'public/assets/vendors/owl.carousel/css');
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.transitions.css', 'public/assets/vendors/owl.carousel/css');
mix.copy('resources/assets/vendors/owlCarousel/owl-carousel/owl.carousel.js', 'public/assets/vendors/owl.carousel/js');
...
mix.styles(
    [
        srcCss + 'chandra_bootstrap.css',
        vendors + 'font-awesome/css/font-awesome.min.css',
        srcCss + 'custom_css/chandra.css',
        srcCss + 'custom_css/metisMenu.css',
        srcCss + 'custom_css/panel.css'
...
mix.scripts(
    [
        ...
        srcJs + 'custom_js/metisMenu.js',
        srcJs + 'custom_js/app.js'
